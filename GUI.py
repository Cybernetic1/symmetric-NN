# ***** This is a stub for GUI for use in playing tic-tac-toe *****
# some buttons should be removed / changed.
...
root = tk.Tk()
root.title("AGI with permutation-invariant deep learning, playing tic-tac-toe")
...
def butt_train_pop():
	from TicTacToe import playGames
